...
const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ label, error, helperText, fullWidth = false, className = '', containerClassName = '', ...rest }, ref) => {
    const baseClasses = 'px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-1';
